...
const OptionsBox = ({ actions }: OptionsBoxProps) => {
  return (
    <div className="relative py-2 group">
      ...
      <div className="absolute top-full right-0 z-20 w-36 p-5 rounded-md bg-[#282142] border border-gray-600 text-gray-100 hidden group-hover:flex flex-col gap-4">
        {actions.map((a, index) => (
          <div key={index}>
